...
public class Patron {
  ...
  Patron(
    ...
    this.placingOnHoldPolicies =
        Objects.requireNonNull(placingOnHoldPolicies, "placingOnHoldPolicies");
    this.overdueCheckouts = Objects.requireNonNull(overdueCheckouts, "overdueCheckouts");
    this.patronHolds = Objects.requireNonNull(patronHolds, "patronHolds");
    this.status = status;
  ...
  public boolean equals(Object other) {
    return this == other || other instanceof Patron that && patron.equals(that.patron);
  }
